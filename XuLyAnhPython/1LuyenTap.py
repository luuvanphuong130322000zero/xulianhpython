...
#a hsv kenh h / Chuyển ảnh sang biểu diễn HSV được ma trận Ihsv. Hiển thị kênh H của Ihsv.
Ihsv=cv2.cvtColor(I,cv2.COLOR_BGR2HSV)
cv2.imshow('Anh HSV:',Ihsv[:,:,0])
#b can bang kenh v / Cân bằng histogram của kênh V của Ihsv. Hiển thị kênh V được cân bằng.
w=Ihsv.shape[1] 
h=Ihsv.shape[0] 
def tinh_his(Igray): 
...
#c I2 hsv - rgb / Thay đổi kênh V của Ihsv thành kênh V đã cân bằng. Chuyển Ihsv về biểu diễn RGB được ảnh I2. Hiển thị I2.
